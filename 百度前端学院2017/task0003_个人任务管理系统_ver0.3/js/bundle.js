...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_html__ = __webpack_require__(17);
...
class File {
	constructor(opt) {
		this.$container = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.container);
	...
	genHtml() {
		let html = __WEBPACK_IMPORTED_MODULE_2__index_html___default()({
			fileId: this.fileId,
		...
		this.$element = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(html);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_html__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__index_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__File__ = __webpack_require__(4);
/**
 * 文件夹
 */
...
class Folder {
	...
	// 新建一个File
	addFile(title) {
		let subItem = new __WEBPACK_IMPORTED_MODULE_3__File__["a" /* default */]({
			folderId: this.folderId,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utlis_pubsub__ = __webpack_require__(1);
/**
 * 内容编辑
 */
...
class Content {
	constructor(opt) {
		this.$container = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.container);
		this.$title = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.title);
		this.$date = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.date);
		this.$content = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.content);
		this.$completeBtn = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.completeBtn);
		this.$saveBtn = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(opt.saveBtn);
	...
	bindEvents() {
		...
		this.$completeBtn.on('click', e => {
			...
			__WEBPACK_IMPORTED_MODULE_1__utlis_pubsub__["a" /* default */].publish('updateCurrentFile', { complete: !completeFlag });
		...
		this.$saveBtn.on('click', e => {
			...
			__WEBPACK_IMPORTED_MODULE_1__utlis_pubsub__["a" /* default */].publish('updateCurrentFile', data);
		});
	}
	...
	showEditArea() {
		//显示编辑区域
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.right_default').css('display', 'none');
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.right').css('display', 'block');
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Folder_index_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utlis_pubsub__ = __webpack_require__(1);
...
class MenuList {
	constructor(opt) {
		this.$container = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(opt.container);
		this.$addFileBtn = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(opt.addFileBtn);
		this.$exportBtn = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(opt.exportBtn) || null;
	...
	delegateEvents() {
		...
		this.$container.on('click', '[actionType="folder.clk"]', e => {
			this.$currentTarget = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.currentTarget);
			...
			__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.left').find('.list_item_select').removeClass('list_item_select');
		...
		this.$addFileBtn.on('click', e => {
			if (this.$currentTarget != null) {
				...
				if (folderInstance) {
					...
					__WEBPACK_IMPORTED_MODULE_2__utlis_pubsub__["a" /* default */].publish('updateCurrentFile', { folderId: folderId, fileId: fileId });
					this.renderSubMenu(folderInstance);
				}
			} else {
		...
		// 删除 file 
		__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.mid_main_list').on('click', '.delete_icon_2', e => {
			e.stopPropagation(); //阻止冒泡很关键。要不然就会触发两个事件，一个是本事件，一个是单击file的事件

			let $currentFile = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.currentTarget).parent('li');
	...
	renderSubMenu(folderInstance) {
		...
		__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.mid_main_list').html(files);
	}
	...
	addNewFolder() {
		...
		if (text) {
			folder = new __WEBPACK_IMPORTED_MODULE_0__Folder_index_js__["a" /* default */]({
	...
	deleteFolder(folderId) {
		...
		if (this.$currentTarget != null) {
			...
			if (this.$currentTarget.data('folderid') == folderId) {
				__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.mid_main_list').html('');
			}
		}
	}
	...
	updateCurrentFile(folderId, fileId, data) {
		...
		if (currentFile) {
			...
			__WEBPACK_IMPORTED_MODULE_2__utlis_pubsub__["a" /* default */].publish('editCurrentFile', { folderId, fileId });
		}
...
class SubMenu {
	...
	bindFileClk() {
		this.$container.on('click', '[actionType="file.clk"]', e => {
			this.$currentTarget = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.currentTarget);
			let folderId = this.$currentTarget.data('folderid');
			let fileId = this.$currentTarget.data('fileid');

			this.toggleClass();

			__WEBPACK_IMPORTED_MODULE_1__utlis_pubsub__["a" /* default */].publish('editCurrentFile', { folderId: folderId, fileId: fileId });
		});
	}
...
// module
exports.push([module.i, ".m-folder span{\r\n\tdisplay: block;\r\n}\r\n\r\n.level-1-icon{\r\n\tmargin-top: 2px;\r\n\tleft: 40px;\r\n\tposition: absolute;\r\n\twidth: 24px;\r\n\theight: 24px;\r\n\tbackground: url(\"https://shared-https.ydstatic.com/ynote/ydoc/e1e06b7a.sprite.svg\") no-repeat;\r\n\tbackground-position: 59.07692307692308% 83.38461538461539%;\r\n}\r\n.level-2-icon{\r\n\tmargin-top: 5px;\r\n\tleft: 54px;\r\n\tposition: absolute;\r\n\twidth: 24px;\r\n\theight: 24px;\r\n\tbackground: url(\"https://shared-https.ydstatic.com/ynote/ydoc/e1e06b7a.sprite.svg\") no-repeat;\r\n\tbackground-position: 55.333% 90%;\r\n}\r\n\r\n.list_item_select{\r\n\tbackground: #398dee;\r\n\tcolor: #fff;\r\n}\r\n\r\n.delete_icon{\r\n\tposition: absolute;\r\n\tbackground: url(\"https://shared-https.ydstatic.com/ynote/ydoc/e1e06b7a.sprite.svg\") no-repeat;\r\n\tbackground-position: 93.9209726443769% 37.38601823708207%;\r\n\twidth: 20px;\r\n\theight: 20px;\r\n\tright: 26px;\r\n\tmargin-top: -24px;\r\n\tdisplay: none;\r\n}\r\n.type_list_all li:hover .delete_icon{/*这里用来替代鼠标移入移出事件*/\r\n    display: block;\r\n}", ""]);
...
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<li class=\"this_title\" actionType=\"file.clk\" data-folderId=\"");t.b(t.v(t.f("folderId",c,p,0)));t.b("\" data-fileId=\"");t.b(t.v(t.f("fileId",c,p,0)));t.b("\" >\r");t.b("\n" + i);t.b("	<span class='");t.b(t.v(t.f("complete",c,p,0)));t.b("'>");t.b(t.v(t.f("title",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("	<span class='outline'>");t.b(t.v(t.f("outline",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("	<i class=\"delete_icon_2\"></i>\r");t.b("\n" + i);t.b("</li>");return t.fl(); },partials: {}, subs: {  }}, "<li class=\"this_title\" actionType=\"file.clk\" data-folderId=\"{{folderId}}\" data-fileId=\"{{fileId}}\" >\r\n\t<span class='{{complete}}'>{{title}}</span>\r\n\t<span class='outline'>{{outline}}</span>\r\n\t<i class=\"delete_icon_2\"></i>\r\n</li>", H);return T.render.apply(T, arguments); };
...
var H = __webpack_require__(6);
module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<li class=\"m-folder\" actionType=\"folder.clk\" data-folderId=\"");t.b(t.v(t.f("folderId",c,p,0)));t.b("\" data-folderLevel=\"");t.b(t.v(t.f("folderLevel",c,p,0)));t.b("\">\r");t.b("\n" + i);t.b("		<i class=\"");t.b(t.v(t.f("folderLevel",c,p,0)));t.b("-icon\"></i>\r");t.b("\n" + i);t.b("		<span>");t.b(t.v(t.f("title",c,p,0)));t.b("</span>\r");t.b("\n" + i);t.b("		<i class=\"delete_icon\"></i>\r");t.b("\n" + i);t.b("	<ul class=\"m-folder-bd js-folder-bd\"></ul>\r");t.b("\n" + i);t.b("</li>");return t.fl(); },partials: {}, subs: {  }}, "<li class=\"m-folder\" actionType=\"folder.clk\" data-folderId=\"{{folderId}}\" data-folderLevel=\"{{folderLevel}}\">\r\n\t\t<i class=\"{{folderLevel}}-icon\"></i>\r\n\t\t<span>{{title}}</span>\r\n\t\t<i class=\"delete_icon\"></i>\r\n\t<ul class=\"m-folder-bd js-folder-bd\"></ul>\r\n</li>", H);return T.render.apply(T, arguments); };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utlis_pubsub__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_MenuList_index__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_SubMenu_index__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Content_index__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Folder_index__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_File_index__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utlis_store__ = __webpack_require__(11);
...
//新建localstorage
__WEBPACK_IMPORTED_MODULE_8__utlis_store__["a" /* default */].store('menulist');

//存储当前操作的 folderId 和 fileId
let currentFolderAndFile = null;

//init MenuList SubMenu Content
let menuList = new __WEBPACK_IMPORTED_MODULE_3__components_MenuList_index__["a" /* default */]({
	container: '.type_list_all',
	addFileBtn: '.add_item'
});

let subMenu = new __WEBPACK_IMPORTED_MODULE_4__components_SubMenu_index__["a" /* default */]({
	container: '.mid_main_list'
});

let content = new __WEBPACK_IMPORTED_MODULE_5__components_Content_index__["a" /* default */]({
	container: '.right',
	title: '.todo_input',
	date: '.todo_date_span',
...
if (JSON.parse(localStorage[window._dbName]) != '' && JSON.parse(localStorage[window._dbName]) != null) {
	...
	for (let i = 0; i < data.length; i++) {
		let folder = new __WEBPACK_IMPORTED_MODULE_6__components_Folder_index__["a" /* default */]({
			container: '.type_list_all',
		...
		if (data[i].subItems.length !== 0) {
			...
			for (let j = 0; j < data[i].subItems.length; j++) {
				let file = new __WEBPACK_IMPORTED_MODULE_7__components_File_index__["a" /* default */]({
...
//编辑当前 file
__WEBPACK_IMPORTED_MODULE_2__utlis_pubsub__["a" /* default */].subscribe('editCurrentFile', data => {
...
//更新当前 file
__WEBPACK_IMPORTED_MODULE_2__utlis_pubsub__["a" /* default */].subscribe('updateCurrentFile', data => {
...
function updateCurrentFile(data) {
	...
	__WEBPACK_IMPORTED_MODULE_8__utlis_store__["a" /* default */].update(menuList.folders);
}

//添加新文件夹
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.add_list').on('click', e => {
	e.stopPropagation();
...
//删除文件夹
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.type_list_all').on('click', '.delete_icon', e => {
	e.stopPropagation();
	let $currentTarget = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.currentTarget).parent('li');
...
// 点击 所有任务
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('[actionType="allfile.clk"]').on('click', e => {
	let data = menuList.getFilesHtml();
	let $currentTarget = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.currentTarget);

	e.stopPropagation();

	__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.left').find('.list_item_select').removeClass('list_item_select');
	$currentTarget.find('span').addClass('list_item_select');
	__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.mid_main_list').html(data);
});

//导出数据
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(".export").on('click', e => {
	//
	console.log(JSON.parse(localStorage[window._dbName]));
	alert("成功导出数据");
});
...
//导入数据
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('.import').on('click', e => {
	//
	alert('导入成功');
});
